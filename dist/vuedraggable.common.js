...
var pluginEvent = function pluginEvent(eventName, sortable) {
  ...
  PluginManager.pluginEvent.bind(Sortable)(eventName, sortable, _objectSpread({
    ...
    dragStarted: sortable_esm_moved,
...
/** @lends Sortable.prototype */
{
  ...
  evt) {
    ...
    if (evt) {
      ...
      if (dragEl) {
        ...
        if (sortable_esm_moved && !awaitingDragStarted) {
        ...
        if (rootEl !== parentEl) {
          ...
          if (sortable_esm_newIndex !== sortable_esm_oldIndex) {
            if (sortable_esm_newIndex >= 0) {
        ...
        if (Sortable.active) {
          ...
          if (sortable_esm_newIndex == null || sortable_esm_newIndex === -1) {
            sortable_esm_newIndex = sortable_esm_oldIndex;
  ...
  _nulling: function _nulling() {
    ...
    rootEl = dragEl = parentEl = ghostEl = nextEl = cloneEl = lastDownEl = cloneHidden = tapEvt = touchEvt = sortable_esm_moved = sortable_esm_newIndex = newDraggableIndex = sortable_esm_oldIndex = oldDraggableIndex = lastTarget = lastDirection = putSortable = activeGroup = Sortable.dragged = Sortable.ghost = Sortable.clone = Sortable.active = null;
...
if (MultiDragPlugin && !MultiDragPlugin.singleton) {
  MultiDragPlugin.singleton = new MultiDragPlugin();
  sortable_esm.mount(MultiDragPlugin.singleton);
}
...
var draggableComponent = {
  ...
  mounted: function mounted() {
    ...
    this._sortable = new sortable_esm(this.rootContainer, options);
    this.computeIndexes();
  },
...
/* concated harmony reexport Sortable */__webpack_require__.d(__webpack_exports__, "Sortable", function() { return sortable_esm; });
/* concated harmony reexport MultiDrag */__webpack_require__.d(__webpack_exports__, "MultiDrag", function() { return MultiDragPlugin; });
